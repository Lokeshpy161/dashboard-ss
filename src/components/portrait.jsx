    ...
    <div className="container mx-auto mt-8">
      ...
      <table className="min-w-full border-2  border-blue-300  rounded-lg overflow-hidden">
        ...
        <tbody>
          ...
          <tr className="hover:bg-blue-100">
            <td className="py-2 px-4 border-r border-blue-300">Plaque Paysage pour pose Paysage</td>
            <td className="py-2 px-4 border-r border-blue-300">1</td>
          ...
          <tr className="hover:bg-blue-100">
            <td className="py-2 px-4 border-r border-blue-300">Vis FixSupport 6,3x22</td>
